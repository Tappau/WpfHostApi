...
using WpfHostApi.Exceptions;
using WpfHostApi.ViewModels;
using WpfHostApi.Windows;

namespace WpfHostApi.Core
{
    public class WindowExceptionHandler
    {
        ...
        public virtual void OnUnhandledException(Exception e)
        {
            Application.Current.Dispatcher.BeginInvoke(new Action(() =>
            {
                ...
                exceptionWindow.DataContext = new ExceptionWindowViewModel(e);
